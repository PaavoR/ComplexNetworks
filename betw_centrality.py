# -*- coding: utf-8 -*-
"""
Created on Fri Apr 24 10:09:46 2020
...
def plot_betweenes_centrality(G, style):
    C_real = nx.betweenness_centrality(G)
    G_deg = G.degree()
